...
def main():
    ...
    # Crop the full width at y: 651 to 716
    hand_crop = img[651:716, 0:img.shape[1]]
    ...
    # Let's average y from 37 to 50 for each x across the entire width (0 to width)
    col_means = np.mean(gray[37:50, :], axis=0)
    
    print(f"Full UI crop width: {gray.shape[1]}px")
    print("\nHorizontal brightness profile of entire UI width:")
